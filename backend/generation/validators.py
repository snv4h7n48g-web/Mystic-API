...
RETRY_HINTS = {
    ...
    "feng_shui": "Correct the output into a Feng Shui space analysis. Refer to rooms, layout, placement, flow, clutter, direction, and practical recommendations. Build distinct sections for overview, bagua map, energy flow, priority actions, recommendations, and guidance. Priority actions must not be empty, and the recommendations must say what to move, clear, place, adjust, add, or remove in concrete terms.",
