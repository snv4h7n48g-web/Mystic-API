...
PRODUCT_ROUTES: dict[str, ProductRoute] = {
    "daily": ProductRoute(
        ...
        preview_model_id=_env("MYSTIC_ROUTE_DAILY_PREVIEW_MODEL", DEFAULT_ANTHROPIC_TEXT_MODEL),
        full_model_id=_env("MYSTIC_ROUTE_DAILY_FULL_MODEL", DEFAULT_ANTHROPIC_TEXT_MODEL),
        fallback_model_id=_env("MYSTIC_ROUTE_DAILY_FALLBACK_MODEL", DEFAULT_ANTHROPIC_TEXT_MODEL),
        preview_max_tokens=1800,
    ...
    "lunar": ProductRoute(
        ...
        full_profile_id="full_premium",
        preview_model_id=_env("MYSTIC_ROUTE_LUNAR_PREVIEW_MODEL", DEFAULT_ANTHROPIC_TEXT_MODEL),
        full_model_id=_env("MYSTIC_ROUTE_LUNAR_FULL_MODEL", DEFAULT_ANTHROPIC_TEXT_MODEL),
        fallback_model_id=_env("MYSTIC_ROUTE_LUNAR_FALLBACK_MODEL", DEFAULT_ANTHROPIC_TEXT_MODEL),
        preview_max_tokens=1800,
    ...
    "tarot": ProductRoute(
        ...
        preview_profile_id="preview_mystic",
        full_profile_id="full_premium",
        preview_model_id=_env("MYSTIC_ROUTE_TAROT_PREVIEW_MODEL", DEFAULT_ANTHROPIC_TEXT_MODEL),
        full_model_id=_env("MYSTIC_ROUTE_TAROT_FULL_MODEL", DEFAULT_ANTHROPIC_TEXT_MODEL),
        fallback_model_id=_env("MYSTIC_ROUTE_TAROT_FALLBACK_MODEL", DEFAULT_ANTHROPIC_TEXT_MODEL),
        preview_max_tokens=1800,
    ...
    "full_reading": ProductRoute(
        ...
        preview_profile_id="preview_mystic",
        full_profile_id="full_premium",
        preview_model_id=_env("MYSTIC_ROUTE_FULL_READING_PREVIEW_MODEL", DEFAULT_ANTHROPIC_TEXT_MODEL),
        full_model_id=_env("MYSTIC_ROUTE_FULL_READING_FULL_MODEL", DEFAULT_ANTHROPIC_TEXT_MODEL),
        fallback_model_id=_env("MYSTIC_ROUTE_FULL_READING_FALLBACK_MODEL", DEFAULT_ANTHROPIC_TEXT_MODEL),
        preview_max_tokens=1800,
    ...
    "palm": ProductRoute(
        ...
        preview_profile_id="preview_mystic",
        full_profile_id="full_premium",
        preview_model_id=_env("MYSTIC_ROUTE_PALM_PREVIEW_MODEL", DEFAULT_ANTHROPIC_TEXT_MODEL),
        full_model_id=_env("MYSTIC_ROUTE_PALM_FULL_MODEL", DEFAULT_ANTHROPIC_TEXT_MODEL),
        fallback_model_id=_env("MYSTIC_ROUTE_PALM_FALLBACK_MODEL", DEFAULT_ANTHROPIC_TEXT_MODEL),
        preview_max_tokens=1800,
        full_max_tokens=2600,
    ...
    "compatibility": ProductRoute(
        ...
        preview_profile_id="preview_mystic",
        full_profile_id="full_premium",
        preview_model_id=_env("MYSTIC_ROUTE_COMPATIBILITY_PREVIEW_MODEL", DEFAULT_ANTHROPIC_TEXT_MODEL),
        full_model_id=_env("MYSTIC_ROUTE_COMPATIBILITY_FULL_MODEL", DEFAULT_ANTHROPIC_TEXT_MODEL),
        fallback_model_id=_env("MYSTIC_ROUTE_COMPATIBILITY_FALLBACK_MODEL", DEFAULT_ANTHROPIC_TEXT_MODEL),
        preview_max_tokens=1800,
    ...
    "feng_shui": ProductRoute(
        ...
        preview_model_id=_env("MYSTIC_ROUTE_FENG_SHUI_PREVIEW_MODEL", DEFAULT_ANTHROPIC_TEXT_MODEL),
        full_model_id=_env("MYSTIC_ROUTE_FENG_SHUI_FULL_MODEL", DEFAULT_ANTHROPIC_TEXT_MODEL),
        fallback_model_id=_env("MYSTIC_ROUTE_FENG_SHUI_FALLBACK_MODEL", DEFAULT_ANTHROPIC_TEXT_MODEL),
        preview_max_tokens=1800,
        full_max_tokens=2400,
